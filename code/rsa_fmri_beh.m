function [] = rsa_fmri_beh()

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% fMRI-behavior RSA script for:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Required data
% fMRI and behavior RDMs have to be downloaded and located in: 
% ../data/fMRI/fMRI_RDM and ../data/beh/beh_RDM
...
%% Time decoding
for i_sub = 1:nsubs
	[result]=rsa_roi_beh_behavg(i_sub);
	matrix_allsub(i_sub,:) = result;
end

% save accuracy per time point for all subjects
save(sprintf('../output/RSA_fMRI_beh_allsub.mat'),'matrix_allsub');
...
plot_statistics_rsa_fmri_beh(matrix_allsub);
